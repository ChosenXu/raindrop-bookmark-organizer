...
Tag skeleton: three axes (Domain 1–2, Type 1, Status 0–2) plus up to 2 free supplementary tags — **hard cap 6 tags per bookmark**. Full rules in `references/vocabulary.md`.
